...
use App\Exports\FreeAnswerExport;
use App\Exports\MultiAnswerExport;
...
class QuestionController extends Controller
{
    ...
    {
        return Excel::download(new MultiAnswerExport(), 'multi_answ.csv');
    }
    public function export3()
    {
        return Excel::download(new FreeAnswerExport(), 'free_answ.csv');
    }
