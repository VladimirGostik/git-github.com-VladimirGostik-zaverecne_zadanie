...
return [
    ...
    'auth_user' => "Prihlásený používateľ",
    'auth_user_text' => "Ako prihlásený používateľ máte prístup k širšiemu spektru funkcionalít. Po úspešnej registrácii a prihlásení do aplikácie si môžete meniť svoje heslo a vytvárať hlasovacie otázky. Pri tvorbe otázok máte na výber medzi otázkami s výberom správnej odpovede a otázkami s otvorenou odpoveďou. K otázkam viete definovať pod aký predmet spáda. Pri otázkach s otvorenou odpoveďou môžete nastaviť, či sa výsledky zobrazia ako zoznam alebo vo forme word cloudu. Okrem toho môžete existujúce otázky upravovať. ",
    'admin' => "Administrátor",
    'admin_text' => "Ako administrátor máte prístup k všetkým funkciám prihláseného používateľa, a navyše môžete spravovať hlasovacie otázky všetkých používateľov. Pri vytváraní novej hlasovacej otázky môžete špecifikovať, v mene koho ju vytvárate.",
    'other_tetx' =>""
];
